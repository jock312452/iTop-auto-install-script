...
yum install -y httpd mariadb mariadb-server php70w.x86_64 php70w-common.x86_64 php70w-mysql.x86_64 php70w-mcrypt.x86_64 php70w-xmlrpc php70w-cli.x86_64 php70w-soap.x86_64 php70w-ldap.x86_64 php70w-gd.x86_64 php70w-xml.x86_64 php70w-imap.x86_64 graphviz wget unzip expect 1>>/itop_install.log 2>>/itop_install_error.log
...
cp -R /iTop-2.4.1/iTop-2.4.1/web/* /var/www/html/itop/ 1>>/itop_install.log 2>>/itop_install_error.log
